class PubSubBusInstall < Rails::Generators::Base

  def create_pub_sub_bus_file
    create_file "app/service_classes/services/pub_sub_bus.rb", pub_sub_bus_class_contents
  end


private
  def pub_sub_bus_class_contents
    <<-'FILE'
module Services
  module PubSubBus
    module Publisher
