class ComposerFor::Staff::PostVotePolls::Create < ComposerFor::Base
  ...
  def compose
    cmpsr = initialize_post_vote_poll_create_cmpsr
  ...
  def initialize_post_vote_poll_create_cmpsr
    ComposerFor::PostVotePoll::Create.new(@params, @controller) 
  end


  def initialize_post_node
    @post_node = PostNode.new
    @post_node.node = @post_vote_poll
