class ComposerFor::Staff::VideoEmbeds::Create < ComposerFor::Base
  ...
  def compose
    cmpsr = initialize_video_embed_create_cmpsr
  ...
  def initialize_video_embed_create_cmpsr
    ComposerFor::VideoEmbeds::Create.new(@params, @controller) 
  end


  def initialize_post_node
    @post_node = PostNode.new
    @post_node.node = @video_embed
